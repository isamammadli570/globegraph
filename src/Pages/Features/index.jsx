    ...
    >
      <div className="flex  flex-col lg:flex-row justify-between items-start gap-10">
        <motion.div
          ...
          className="lg:w-1/4 "
        >
          <h3 className="text-3xl darkApp text-primary font-bold lg:w-1/2 mb-3">
          ...
          >
            <div className="bg-[rgba(255, 255, 255, 0.5)] rounded-[35px]  h-96 shadow-3xl p-8 flex items-center justify-center hover:-translate-y-4 transition-all duration-300 cursor-pointer">
              <div>
                ...
                <h5 className="text-2xl  font-semibold darkApp text-primary px-5 text-center mt-5">
            ...
            <div className="bg-[rgba(255, 255, 255, 0.5)] rounded-[35px] h-96 shadow-3xl p-8 flex items-center justify-center hover:-translate-y-4 transition-all duration-300 cursor-pointer">
              <div>
                <img src="road.png" alt="" />
                <h5 className="text-2xl font-semibold text-primary px-5 darkApp text-center mt-5">
